...
<head>
    ...
    <title>VANDANA HOSPITALITY | Hospital housekeeping</title>
                        ...
                        <ul>
                            ...
                            <li><a href="#">services</a>
                                <ul class="dropdown" style="width:250px;">
                                    <li class="active"><a href="{{ route('frontend.hospital_housekeeping') }}">Hospital housekeeping</a></li>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="breadcrumb__text">
                    <h2>Hospital Housekeeping</h2>
                    <div class="breadcrumb__links">
                        <a href="{{ route('welcome') }}">Home</a>
                        <span>Hospital Housekeeping</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="about__pic">
                        <div class="about__pic__inner ">
                            <img src="{{ asset('Career/img/job/hospital-housekeeping-services_1.jpg') }}" alt=""> <!-- Adjust the path if necessary -->
                        </div>
						<ul class="HOSPITAL">
                         <li>Scheduled Polishing Of Steel & Wooden Furniture.</li>
                            <li>Scheduled Special Washing & Scrubbing Of Floors With Equipment & Manually.</li>
                            <li>Collection Of Kitchen Disposal From Designated Area & Depositing In The Pre-Designated Garbage Collection Area.</li>
                            <li>Cleaning Of Waste Bins And Collection Of General Waste From All Public Areas.</li>
                            <li>Sweeping, Washing And Stain Removal Of Terraces.</li>
                             <li>Regular & Routine Cleaning Of All Toilets Along With Scheduled Deep Cleaning.</li>
                            <li>Replenishment Of Toiletries As Provided By The Hospital.</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="about__text">
                        <h4>HOSPITAL – HOUSEKEEPING</h4>
                        <p style="color:#12c5c5;">SCOPE OF SERVICES:</p>
                        <ul class="HOSPITAL">
                            <li>Removal Of Dirt In All The Areas Through, Sweeping, Dusting And Mopping On A Routine And Regular Basis.</li>
                            <li>Regular And Scheduled Top Dusting And Cleaning Of All Ceiling And Wall Mounted Fixtures Like Lights, Fans, AC Ducts And Exhaust Grills.</li>
                            <li>Regular Cleaning Of Signage And Other Fixtures.</li>
                            <li>Removal Of All Wall Stains Including Spitting, Scuffmarks & Cobwebs Or As And When Required.</li>
                            <li>Scheduled Cleaning Of All Corners, Grooves, Behind Furniture And Mats.</li>
                         </ul>
                          <div class="about__pic__inner ">
                            <img src="{{ asset('Career/img/job/s5.jpg') }}" alt=""> <!-- Adjust the path if necessary -->
                        </div>
                    </div>
                </div>
            </div>
